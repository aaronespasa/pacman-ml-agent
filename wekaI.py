# clasificar dirección con información del "presente" y predecir puntuación con la información del "futuro"
# fase 2.3 -> el atributo directionsTaken es un atributo de futuro
